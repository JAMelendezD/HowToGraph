...
parser.add_argument("equation", type=str, help="Set the plot argument as new then type any function with variables X and Y you can use numpy functions but need to write parentheses in between ''. If you are using an example in the plot argument you still need to type anything you want in this argument")
